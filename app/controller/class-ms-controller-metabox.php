		...
		if ( ! $Message ) {
			...
			mslib3()->ui->admin_message(
				__(
					...
					'Der Seiteninhalt wird auf den Standardinhalt zurückgesetzt, <em>ist jedoch noch nicht gespeichert</em>!<br />' .
					'Du kannst diese Seite einfach schließen, um den aktuellen Seiteninhalt beizubehalten.',
					'membership2'
				)
			);
		}
