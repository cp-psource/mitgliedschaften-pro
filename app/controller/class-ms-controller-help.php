...
class MS_Controller_Help extends MS_Controller {
	...
	public function get_tabs() {
		$tabs = array(
			...
			'network' 	=> array(
				'title' 	=> __( 'Netzwerkweiter Schutz', 'membership2' ),
			),
			'advanced' 	=> array(
				'title' 	=> __( 'Erweiterte Einstellungen', 'membership2' ),
			),
			'branding' 	=> array(
				'title' 	=> __( 'Anpassen von Mitgliedschaften', 'membership2' ),
			),
			'emails' 	=> array(
				'title' 	=> __( 'E-Mail-Verlauf', 'membership2' ),
			),
