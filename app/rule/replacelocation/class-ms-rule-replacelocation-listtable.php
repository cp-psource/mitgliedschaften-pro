...
class MS_Rule_ReplaceLocation_ListTable extends MS_Helper_ListTable_RuleMatching {
	...
	public function __construct( $model ) {
		...
		$this->name['singular'] = __( 'Menüposition', 'membership2' );
		$this->name['plural'] 	= __( 'Menüpositionen', 'membership2' );
		...
		add_filter(
			'bulk_actions-mitgliedschaften_page_membership2-protection',
	...
	protected function get_column_label( $col ) {
		...
		switch ( $col ) {
			case 'item': $label 	= __( 'Menüposition', 'membership2' ); break;
			case 'match': $label 	= __( 'Zeige dieses Menü den Mitgliedern', 'membership2' ); break;
		}
