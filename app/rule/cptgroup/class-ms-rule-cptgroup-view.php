...
class MS_Rule_CptGroup_View extends MS_View {
	...
	public function to_html() {
		...
		$header_data 			= array();
		$header_data['title'] 	= __( 'Wähle aus, welche benutzerdefinierten Beitragstypen Du schützen möchtest', 'membership2' );
		$header_data['desc'] 	= '';
		...
		<div class="ms-settings ">
			...
			$rule_listtable->search_box( __( 'Beitragstypen', 'membership2' ), 'search-cpt' );
			?>
