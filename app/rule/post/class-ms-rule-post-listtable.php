...
class MS_Rule_Post_ListTable extends MS_Helper_ListTable_Rule {
	...
	public function __construct( $model ) {
		...
		$this->name['singular'] = __( 'Beitrag', 'membership2' );
		$this->name['plural'] 	= __( 'Beiträge', 'membership2' );
	}

	public function get_columns() {
		$columns = array(
			'cb' 		=> true,
			'name' 		=> __( 'Beitragstitel', 'membership2' ),
			'access' 	=> true,
			'post_date' => __( 'Beitragsdatum', 'membership2' ),
			'dripped' 	=> true,
		);
