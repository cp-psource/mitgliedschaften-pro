...
class MS_Rule_ReplaceMenu_ListTable extends MS_Helper_ListTable_RuleMatching {
	...
	public function __construct( $model ) {
		...
		$this->name['singular'] = __( 'Menü', 'membership2' );
		$this->name['plural'] 	= __( 'Menüs', 'membership2' );
	...
	protected function get_column_label( $col ) {
		...
		switch ( $col ) {
			case 'item': $label 	= __( 'Menü', 'membership2' ); break;
			case 'match': $label 	= __( 'Durch dieses Menü ersetzen', 'membership2' ); break;
		}
