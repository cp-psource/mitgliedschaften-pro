	...
	protected function get_special_pages() {
		if ( ! is_array( $this->_content ) ) {
			...
			$this->_content['archive'] = (object) array(
				'label' => __( 'Beliebige Archivseite', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['author'] = (object) array(
				'label' => __( 'Autorenarchiv', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['date'] = (object) array(
				'label' => __( 'Beliebiges Datums- oder Zeitarchiv', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['year'] = (object) array(
				'label' => __( 'Archiv: Jahr', 'membership2' ),
				'url' 	=> $arch_year,
			);
			$this->_content['month'] = (object) array(
				'label' => __( 'Archiv: Monat', 'membership2' ),
				'url' 	=> $arch_month,
			);
			$this->_content['day'] = (object) array(
				'label' => __( 'Archiv: Tag', 'membership2' ),
				'url' 	=> $arch_day,
			);
			$this->_content['time'] = (object) array(
				'label' => __( 'Archiv: Zeit', 'membership2' ),
				'url' 	=> $arch_hour,
			);

			// Singular pages
			$this->_content['front'] = (object) array(
				'label' => __( 'Titelseite', 'membership2' ),
				'url' 	=> $front_url,
			);
			...
			$this->_content['notfound'] = (object) array(
				'label' => __( '404 Nicht gefunden', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['search'] = (object) array(
				'label' => __( 'Suchergebnisse', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['single'] = (object) array(
				'label' => __( 'Jede einzelne Seite oder jeder einzelne Beitrag', 'membership2' ),
				'url' 	=> '',
			);
			$this->_content['attachment'] = (object) array(
				'label' => __( 'Beliebige Anhangsseite', 'membership2' ),
				'url' 	=> '',
			);
		}
