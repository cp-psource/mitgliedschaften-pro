	...
	public function to_html() {
		...
		if ( $listtable->list_shows_base_items() ) {
			$add_fields = array(
				'url' 		=> array(
					'id' 		=> 'url_value',
					'title' 	=> __( 'Neue URL-Adresse hinzufügen', 'membership2' ),
				...
				'url_add' 	=> array(
					...
					'value' 	=> __( 'Schütze diese URL', 'membership2' ),
					'button_type' => 'button',
				),
				'url_action' => array(
					'name' 		=> 'rule_action',
		...
		$header_data = apply_filters(
			...
			array(
				'title' => __( 'URL-Einschränkung', 'membership2' ),
				'desc' 	=> array(
					__( 'Gib URLs an, die Du schützen möchtest.', 'membership2' ),
					__( 'z.B. <b>example.com/protectme/</b> schützt alle URLs, die <b>example.com/protectme/</b> enthalten, einschließlich aller untergeordneten Seiten.', 'membership2' ),
				),
				'class' => '',
			),
			MS_Rule_Url::RULE_ID,
