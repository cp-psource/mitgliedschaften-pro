...
class MS_Gateway_Stripe_View_Settings extends MS_View {
	...
	public function to_html() {
		...
		<form class="ms-gateway-settings-form ms-form">
			...
			$description = sprintf(
				'%1$s<br />%2$s',
				__( 'Am besten für einmalige Zahlungen.', 'membership2' ),
				sprintf(
					__( 'Du findest Deine Stripe-API-Schlüssel in Deinen %sKontoeinstellungen%s.', 'membership2' ),
	...
	protected function prepare_fields() {
		...
		$fields = array(
			...
			'vendor_logo' 			=> array(
				'id' 			=> 'vendor_logo',
				'title' 		=> __( 'Händlerlogo (Muss mindestens 128 x 128 Pixel groß sein)', 'membership2' ),
				'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
			...
			'pay_button_url' 		=> array(
				...
				'title' 		=> apply_filters(
					'ms_translation_flag',
					__( 'Etikett der Zahlungsschaltfläche', 'membership2' ),
