...
class MS_Gateway_Authorize_View_Form extends MS_View {
						...
						<table class="form-table ms-form-table">
							<tr>
								<td class="ms-title-row" colspan="2">
									<?php _e( 'Kreditkarteninformation', 'membership2' ); ?>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="ms-title-row" colspan="2">
									<?php _e( 'Abrechnungsdaten', 'membership2' ); ?>
								</td>
							</tr>
							<tr>
	...
	public function prepare_fields() {
		...
		$fields['card'] = array(
			'card_num' => array(
				'id' 			=> 'card_num',
				'title' 		=> __( 'Kartennummer', 'membership2' ),
			...
			'card_code' => array(
				'id' 			=> 'card_code',
				'title' 		=> __( 'Kartencode', 'membership2' ),
				'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
				'placeholder' 	=> 'CVC',
				'maxlength' 	=> 4,
			),
		...
		$fields['billing'] = array(
			...
			'last_name' => array(
				...
				'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
				'placeholder' 	=> __( 'Nachname', 'membership2' ),
			),
			'country' => array(
				'id' 			=> 'country',
				'title' 		=> __( 'Land', 'membership2' ),
				'type' 			=> MS_Helper_Html::INPUT_TYPE_SELECT,
		...
		$fields['submit'] = array(
			...
			'value' 	=> __( 'Zahle jetzt', 'membership2' ),
		);
		...
		if ( 'update_card' == $this->data['action'] ) {
			$fields['submit']['value'] = __( 'Karte wechseln', 'membership2' );
		}
	...
	protected function render_cim_profiles( $fields ) {
		...
		$options[ 0 ] = __( 'Gib eine neue Kreditkarte ein', 'membership2' );
		$cim = array(
			'id' => 'profile',
		...
		$card_cvc = array(
			'id' 			=> 'card_code',
			'title' 		=> __( 'Gib den CVC-Code der Kreditkarte ein, um die Zahlung zu überprüfen', 'membership2' ),
			'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
			'placeholder' 	=> 'CVC',
			'maxlength' 	=> 4,
		);
		...
		<form id="ms-authorize-extra-form" method="post" class="ms-form">
			...
			<div id="ms-authorize-cim-profiles-wrapper" class="authorize-form-block">
				<table>
					<tr>
						<td class="ms-title-row"><?php _e( 'Gespeicherte Kreditkarten', 'membership2' ); ?></td>
					</tr>
					<tr>
