...
class MS_Model_Export_Base extends MS_Model {
	...
	protected function export_base( $type = 'full' ) {
		...
		if ( $type === 'full' ) {
			$data['notes']  	= array(
				'title' => __( 'Exportierte Daten:', 'membership2' ),
				__( '- Mitgliedschaften (ohne Schutzregeln)', 'membership2' ),
				__( '- Mitglieder (einschließlich Stripe/Authorize-Zahlungseinstellungen)', 'membership2' ),
				__( '- Abonnements (Verbindung zwischen Mitgliedern und Mitgliedschaften)', 'membership2' ),
