 ...
 class MS_Model_Report_Members extends MS_Model {
	...
	public function process() {
		...
		$header = apply_filters( 'ms_model_report_members_csv_header', array( 
			__( 'Benutzeridentifikation', 'membership2' ),
			__( 'Email', 'membership2' ),
			__( 'Benutzername', 'membership2' ),
			__( 'Vorname', 'membership2' ),
			__( 'Nachname', 'membership2' ),
			__( 'Name der Mitgliedschaft', 'membership2' ),
			__( 'Abonnementstatus', 'membership2' ),
			__( 'Zahlungs-Gateways', 'membership2' ),
			__( 'Zahlungs-Beschreibung', 'membership2' ),
			__( 'Anfangsdatum', 'membership2' ),
			__( 'Enddatum', 'membership2' )
		) );
