...
class MS_Model_Rule extends MS_Model {
	...
	public static function get_dripped_types() {
		$dripped_types = array(
			self::DRIPPED_TYPE_INSTANTLY 			=> __( 'Sofort', 'membership2' ),
			self::DRIPPED_TYPE_SPEC_DATE 			=> __( 'An einem bestimmten Datum', 'membership2' ),
			self::DRIPPED_TYPE_FROM_REGISTRATION 	=> __( 'Relativ zum Abonnement', 'membership2' ),
		);
