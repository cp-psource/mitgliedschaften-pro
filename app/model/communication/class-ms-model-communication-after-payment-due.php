...
class MS_Model_Communication_After_Payment_Due extends MS_Model_Communication {
	...
	public function set_period_name( $field ) {
		...
		$field['desc'] 	= __( 'Verwende "0", um am Fälligkeitsdatum zu senden, oder einen anderen Wert, um die Nachricht zu verzögern.', 'membership2' );
	...
	public function get_description() {
		return __(
			'Eine Zahlungserinnerung, die eine vordefinierte Anzahl von Tagen nach Fälligkeit der Zahlung gesendet wird (nur wenn die Rechnung bis dahin nicht bezahlt wurde). Du musst entscheiden, wie viele Tage nach dem Senden einer Nachricht.', 'membership2'
		);
	}
	...
	public function reset_to_default() {
		...
		$this->subject 			= __( 'Mitgliedsbeitrag fällig', 'membership2' );
	...
	public static function get_default_message() {
		...
		$body_notice = sprintf(
			__( 'Dies ist eine Erinnerung daran, dass die Zahlung für Deine %1$s-Mitgliedschaft bei %2$s jetzt fällig ist (%3$s).', 'membership2' ),
