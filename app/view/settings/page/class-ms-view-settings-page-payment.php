		...
		<div class="ms-global-payment-wrapper">
			<div class="ms-list-table-wrapper">
				...
				MS_Helper_Html::settings_tab_header(
					array(
						'title' => __( 'Globale Zahlungseinstellungen', 'membership2' ),
						'desc' => __( 'Diese werden auf alle Mitgliedschaften angewendet.', 'membership2' ),
					)
				);
				?>
				...
				<div class="ms-group-head">
					<div class="ms-bold"><?php _e( 'Zahlungsgateways', 'membership2' ); ?></div>
					<div class="ms-description"><?php _e( 'Du musst mindestens ein Zahlungsgateway einrichten, um Zahlungen verarbeiten zu können.', 'membership2' ); ?></div>
				</div>
	...
	protected function get_global_payment_fields() {
		...
		$fields = array(
			'currency' => array(
				...
				'title' => __( 'Zahlungswährung auswählen', 'membership2' ),
			...
			'invoice_sender_name' => array(
				...
				'title' => __( 'Name des Rechnungssenders', 'membership2' ),
	...
	protected function gateway_item_settings( $gateway ) {
		...
		$actions = array(
			sprintf(
				...
				__( 'Transaktionen anzeigen', 'membership2' )
			),
			sprintf(
				'<a href="%1$s">%2$s</a>',
				MS_Controller_Plugin::get_admin_url(
				...
				__( 'Protokolle anzeigen', 'membership2' )
			),
		);
		...
		<div class="ms-gateway-item <?php echo esc_attr( $row_class ); ?>">
			<span class="gateway-title">
				...
				<span class="wpmui-fa offline-flag" title="<?php echo __( 'Die Webseite scheint nicht öffentlich verfügbar zu sein. Diese Zahlungsmethode funktioniert möglicherweise nicht.', 'membership2' ); ?>">
				</span>
			</span>
			...
			<div class="ms-gateway-status <?php echo esc_attr( $active_class ); ?> ms-active-wrapper-<?php echo esc_attr( $gateway->id ); ?>">
				...
				<div class="ms-gateway-setup-wrapper">
					<label for="settings-<?php echo esc_attr( $gateway->id ); ?>" class="button">
						<i class="wpmui-fa wpmui-fa-cog"></i> <?php _e( 'Konfigurieren', 'membership2' ); ?>
					</label>
				</div>
