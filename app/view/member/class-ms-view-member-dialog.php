...
class MS_View_Member_Dialog extends MS_Dialog {
	...
	public function get_contents( $data ) {
		...
		$inp_cancel = array(
			...
			'value' => __( 'Schließen', 'membership2' ),
			'class' => 'close',
		);
					...
					<thead>
						<tr>
							<th class="column-membership">
								<?php _e( 'Mitgliedschaft', 'membership2' ); ?>
							</th>
							<th class="column-status">
								<?php _e( 'Status', 'membership2' ); ?>
							</th>
							<th class="column-start">
								<?php _e( 'Abonniert am', 'membership2' ); ?>
							</th>
							<th class="column-expire">
								<?php _e( 'Läuft aus am', 'membership2' ); ?>
							</th>
							<?php if ( $show_trial ) : ?>
							<th class="column-trialexpire">
								<?php _e( 'Test bis', 'membership2' ); ?>
							</th>
							<?php endif; ?>
							<th class="column-payments">
								<?php _e( 'Zahlungen', 'membership2' ); ?>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="column-status">
								...
								printf(
									...
									__( 'Überprüfen und aktualisiere den Abonnementstatus', 'membership2' )
								);
								?>
							</td>
