...
class MS_View_Membership_List extends MS_View {
	...
	public function to_html() {
		...
		$create_new_button = array(
			...
			'value' => __( 'Neue Mitgliedschaft erstellen', 'membership2' ),
			'class' => 'button',
		);
        ...
        $delete_button = array(
			...
			'value' => __( 'Ausgewählte Mitgliedschaften löschen', 'membership2' ),
		...
		<div class="wrap ms-wrap">
			...
			MS_Helper_Html::settings_header(
				...
				'title' => $title,
				'desc' => array(
						__( 'Hier kannst Du alle von Dir erstellten Mitgliedschaften anzeigen und bearbeiten.', 'membership2' ),
						$admin_message,
					)
				)
			);
