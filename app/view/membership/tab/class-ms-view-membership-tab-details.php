...
class MS_View_Membership_Tab_Details extends MS_View {
	...
	protected function get_fields() {
		...
		$fields['active'] = array(
			...
			'title' => __( 'Diese Mitgliedschaft ist aktiv', 'membership2' ),
			'before' => __( 'Nein', 'membership2' ),
			'after' => __( 'Ja', 'membership2' ),
			'class' => 'ms-active',
		...
		$fields['public'] = array(
			'id' => 'public',
			'type' => MS_Helper_Html::INPUT_TYPE_RADIO_SLIDER,
			'title' => __( 'Diese Mitgliedschaft ist öffentlich', 'membership2' ),
			'desc' => __( 'Benutzer können es auf Deiner Webseite aufgelistet sehen und sich dafür registrieren', 'membership2' ),
			'before' => __( 'Nein', 'membership2' ),
			'after' => __( 'Ja', 'membership2' ),
			'class' => 'ms-public',
		...
		$fields['priority'] = array(
			...
			'title' => __( 'Mitgliedschaftsauftrag', 'membership2' ),
			'desc' => __( 'Dies definiert die Anzeigereihenfolge auf der Mitgliederseite.', 'membership2' ),
			'class' => 'ms-priority',
			'before' => __( 'Sortierung', 'membership2' ),
		...
		if ( MS_Model_Addon::is_enabled( MS_Model_Addon::ADDON_MULTI_MEMBERSHIPS ) ) {
			$fields['priority']['desc'] .= '<br>' .
				__( 'Es steuert auch, welche Schutznachricht verwendet wird, wenn ein Mitglied mehrere Mitgliedschaften hat (der niedrigste Wert gewinnt).', 'membership2' );
		}
