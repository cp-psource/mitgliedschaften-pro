			...
			<div class="cf">
				<div class="ms-half ms-available-soon space">
					<div class="ms-bold">
						...
						<?php _e( 'Verfügbar an einem bestimmten Datum:', 'membership2' ); ?>
					</div>
					<div class="inside">
				...
				<div class="ms-half ms-available">
					<div class="ms-bold">
						...
						<?php _e( 'Bezogen auf die Registrierung:', 'membership2' ); ?>
					</div>
					<div class="inside">
						...
						<div class="ms-protection-edit-wrapper">
							...
							MS_Helper_Html::html_element(
								array(
									...
									'value' => __( 'Bearbeite den gestaffelten Inhalt', 'membership2' ),
									'url' => $edit_url,
