...
class MS_View_Billing_Edit extends MS_View {
	...
	public function to_html() {
		...
		if ( $this->data['invoice']->is_valid() ) {
			$title = __( 'Abrechnung bearbeiten', 'membership2' );
		} else {
			$title = __( 'Abrechnung hinzufügen', 'membership2' );
		}
	...
	function prepare_fields() {
		...
		$fields = array(
			...
			'txt_user' 			=> array(
				'id' 				=> 'txt_user',
				'title' 			=> __( 'Rechnung für Mitglied', 'membership2' ),
				'type' 				=> MS_Helper_Html::TYPE_HTML_TEXT,
				'value' 			=> sprintf(
					'<a href="%s">%s</a>',
					MS_Controller_Plugin::get_admin_url(
			...
			'txt_membership' 	=> array(
				'id' 				=> 'txt_membership',
				'title' 			=> __( 'Zahlung für Mitgliedschaft', 'membership2' ),
				'type' 				=> MS_Helper_Html::TYPE_HTML_TEXT,
			),
			'txt_created' 		=> array(
				'id' 				=> 'txt_created',
				'title' 			=> __( 'Rechnung erstellt am', 'membership2' ),
				'type' 				=> MS_Helper_Html::TYPE_HTML_TEXT,
			),
			'txt_separator' 	=> array(
			...
			'status' 			=> array(
				'id' 				=> 'status',
				'title' 			=> __( 'Rechnungsstatus', 'membership2' ),
			...
			'amount' 			=> array(
				'id' 				=> 'amount',
				'title' 			=> sprintf( __( 'Betrag (%s)', 'membership2' ), $currency ),
			...
			'discount' 			=> array(
				'id' 				=> 'discount',
				'title' 			=> sprintf( __( 'Rabatt (%s)', 'membership2' ), $currency ),
				'type' 				=> MS_Helper_Html::INPUT_TYPE_NUMBER,
			...
			'due_date' 			=> array(
				'id' 				=> 'due_date',
				'title' 			=> __( 'Fälligkeitstermin', 'membership2' ),
				'type' 				=> MS_Helper_Html::INPUT_TYPE_DATEPICKER,
				'value' 			=> $invoice->due_date,
			),
			'description' 		=> array(
				'id' 				=> 'description',
				'title' 			=> __( 'Beschreibung', 'membership2' ),
			...
			'notes' 			=> array(
				'id' 				=> 'notes',
				'title' 			=> __( 'Anmerkungen', 'membership2' ),
			...
			'execute' 			=> array(
				'id' 				=> 'execute',
				'title' 			=> __( 'Ausführen von Statusänderungsaktionen beim Speichern (Hinzufügen/Entfernen der Mitgliedschaft)', 'membership2' ),
				'type' 				=> MS_Helper_Html::INPUT_TYPE_CHECKBOX,
				'value' 			=> true,
			),
			'modify_date' 		=> array(
				'title' 			=> __( 'Verlängere das Ablaufdatum der aktiven Mitgliedschaft, sobald diese bezahlt wurde', 'membership2' ),
				'name' 				=> 'modify_date',
				'type' 				=> MS_Helper_Html::INPUT_TYPE_CHECKBOX,
				'value' 			=> true,
			),
