	...
	function prepare_fields() {
		...
		$fields['info'] = array(
			'id' 			=> array(
				...
				'title' 		=> __( 'Transaktions-ID', 'membership2' ),
				'value' 		=> $log->id,
			),
			'gateway' 		=> array(
				'type' 			=> MS_Helper_Html::TYPE_HTML_TEXT,
				'title' 		=> __( 'Zahlungs-Gateways', 'membership2' ),
				'value' 		=> MS_Model_Gateway::get_name( $log->gateway_id, true ),
			),
			'amount' 		=> array(
				'type' 			=> MS_Helper_Html::TYPE_HTML_TEXT,
				'title' 		=> __( 'Transaktionshöhe', 'membership2' ),
				'value' 		=> MS_Helper_Billing::format_price( $log->amount ),
			),
			'details' 		=> array(
				'type' 			=> MS_Helper_Html::TYPE_HTML_TEXT,
				'title' 		=> __( 'Transaktionsdetails', 'membership2' ),
		...
		$fields['member'] = array(
			'user_id' 		=> array(
				'id' 			=> 'user_id',
				'title' 		=> __( '1. Zahlung durch Benutzer', 'membership2' ),
		...
		$fields['subscription'] = array(
			'subscription_id' => array(
				'id' 			=> 'subscription_id',
				'title' 		=> __( '2. Zahlung für Abonnement', 'membership2' ),
				'type' 			=> MS_Helper_Html::INPUT_TYPE_SELECT,
				'value' 		=> 0,
				'field_options' => array(),
			)
		...
		$fields['invoice'] = array(
			'invoice_id' => array(
				'id' 			=> 'invoice_id',
				'title' 		=> __( '3. Zahlung mit Rechnung verknüpfen', 'membership2' ),
				'type' 			=> MS_Helper_Html::INPUT_TYPE_SELECT,
				'value' 		=> 0,
				'field_options' => array(),
				'after' 		=> __( 'Die ausgewählte Rechnung wird als "bezahlt" markiert.', 'membership2' ),
			)
		);
		...
		$fields['buttons'] = array(
			...
			'submit' => array(
				...
				'value' 		=> __( 'Transaktion speichern', 'membership2' ),
			),
		);
