...
class MS_View_Shortcode_RegisterUser extends MS_View {
	...
	public function to_html() {
		...
		$login_link = array(
			...
			'url' => $login_url,
			'class' => 'alignleft',
			'value' => __( 'Hast Du bereits ein Benutzerkonto?', 'membership2' ),
		);
	...
	public function prepare_fields() {
		...
		if ( $privacy_link = MS_Helper_Utility::get_privacy_page() ) {
			$fields['privacy_check'] = array(
				'id' 	=> 'privacy_check',
				'title' => sprintf( __( 'Durch das Erstellen eines Kontos stimmst Du den %sDatenschutz und Richtlinien%s dieser  Webseite zu', 'membership2' ), '<a href="'.$privacy_link.'" target="_blank">', '</a>' ),
