...
class MS_View_Addon extends MS_View {
	...
	public function to_html() {
		...
		$lang = (object) array(
			'active_badge' 	=> __( 'AKTIV', 'membership2' ),
			'show_details' 	=> __( 'Details...', 'membership2' ),
			'close_details' => __( 'Schließen', 'membership2' ),
		);
		$filters = array(
			'all' 		=> __( 'Alle', 'membership2' ),
			'active' 	=> __( 'Aktiv', 'membership2' ),
			'inactive' 	=> __( 'Inaktiv', 'membership2' ),
			'options' 	=> __( 'Mit Optionen', 'membership2' ),
		);
		...
		<div class="ms-wrap ms-addon-list">
			<h2 class="ms-settings-title">
				...
				<?php  _e( 'Mitgliedschaften-Erweiterungen', 'membership2' ); ?>
			</h2>
