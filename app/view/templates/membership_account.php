<div class="ms-account-wrapper">
        <?php if ( ms_is_user_logged_in() ) : ?>
                ...
                if ( is_ms_admin_user() ) {
                        _e( 'Du bist Administrator und hast Zugriff auf alle Mitgliedschaften', 'membership2' );
                } else {
                        ...
                        <?php
                                ...
                                _e( 'Keine Mitgliedschaften', 'membership2' );
                        }
                }
                /**
                        ...
                        <thead>
                                <tr>
                                        <th class="ms-col-activity-date"><?php
                                                _e( 'Datum', 'membership2' );
                                        ?></th>
                                        <th class="ms-col-activity-title"><?php
                                                _e( 'Aktivität', 'membership2' );
                                        ?></th>
                                </tr>
                        </thead>
                        <tbody>
