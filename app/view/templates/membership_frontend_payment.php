<div class="<?php echo get_ms_pm_membership_wrapper_class(); ?>">
        <legend><?php _e( 'Mitglied werden', 'membership2' ) ?></legend>
        ...
        <table class="ms-purchase-table">
                ...
                <?php if ( is_ms_pm_membership_description() ) : ?>
                        <tr>
                                <td class="ms-title-column">
                                        <?php _e( 'Beschreibung', 'membership2' ); ?>
                                </td>
                ...
                <?php if ( ! is_ms_pm_membership_free() && ! is_ms_admin_user() ) : ?>
                        ...
                        <?php if ( is_ms_pm_invoice_discount() ) : ?>
                                <tr>
                                        <td class="ms-title-column">
                                                <?php _e( 'Gutscheinrabatt', 'membership2' ); ?>
                                        </td>
                        ...
                        <?php if ( is_ms_pm_invoice_pro_rate() ) : ?>
                                <tr>
                                        <td class="ms-title-column">
                                                <?php _e( 'Pro-Rate Rabatt', 'membership2' ); ?>
                                        </td>
                                        <td class="ms-price-column">
                        ...
                        <?php if ( is_ms_pm_trial() ) : ?>
                                <tr>
                                        <td class="ms-title-column">
                                                <?php _e( 'Zahlung fällig', 'membership2' ); ?>
                                        </td>
                                ...
                                <tr>
                                        <td class="ms-title-column">
                                                <?php _e( 'Testmitgliedschaft Preis', 'membership2' ); ?>
                                        </td>
                                        <td class="ms-desc-column">
                                        <?php
                ...
                if ( is_ms_admin_user() ) : ?>
                        <tr>
                                <td class="ms-desc-adminnote" colspan="2">
                                        <em><?php
                                        _e( 'Als Administrator hast Du bereits Zugriff auf diese Mitgliedschaft', 'membership2' );
                                        ?></em>
                                </td>
                        </tr>
                <?php else :
