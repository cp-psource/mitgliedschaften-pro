...
class MS_Addon_BuddyPress_Rule_Model extends MS_Rule {
	...
	public function get_contents( $args = null ) {
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_ALL ] = (object) array(
			...
			'name' 			=> __( 'Alle BuddyPress-Seiten', 'membership2' ),
			'type' 			=> $this->rule_type,
			'description' 	=> __( 'Schütze alle BuddyPress-Seiten. Diese Regel kann mit jeder anderen Regel kombiniert werden.', 'membership2' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_GROUP_CREATION ] = (object) array(
			...
			'name' 			=> __( 'Gruppenerstellung', 'membership2' ),
			'type' 			=> $this->rule_type,
			'description' 	=> __( 'Nur Mitglieder können neue Gruppen erstellen.', 'membership2' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_FRIENDSHIP ] = (object) array(
			...
			'name' 			=> __( 'Freundschaftsanfrage', 'membership2' ),
			'type' 			=> $this->rule_type,
			'description' 	=> __( 'Erlaube nur Mitgliedern, Freundschaftsanfragen zu senden.', 'membership2' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_PRIVATE_MSG ] = (object) array(
			...
			'name' 			=> __( 'Private Nachrichten', 'membership2' ),
			'type' 			=> $this->rule_type,
			'description' 	=> __( 'Erlaube nur Mitgliedern, private Nachrichten zu senden.', 'membership2' ),
