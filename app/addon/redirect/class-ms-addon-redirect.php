...
class MS_Addon_Redirect extends MS_Addon {
	...
	public function register( $list ) {
		$list[ self::ID ] = (object) array(
			'name' => __( 'Umleitungssteuerung', 'membership2' ),
			'description' => __( 'Definiere Deine individuelle URL, die angezeigt werden soll, nachdem ein Benutzer angemeldet oder abgemeldet wurde.', 'membership2' ),
			'icon' => 'wpmui-fa wpmui-fa-share',
			'details' => array(
				array(
					'type' => MS_Helper_Html::TYPE_HTML_TEXT,
					'title' => __( 'Einstellungen', 'membership2' ),
					'desc' => __( 'Wenn dieses Add-On aktiviert ist, wird auf der Seite "Einstellungen" ein neuer Abschnitt mit zusätzlichen Optionen angezeigt.', 'membership2' ),
				),
			),
		);
