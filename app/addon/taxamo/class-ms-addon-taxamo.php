...
class MS_Addon_Taxamo extends MS_Addon {
	...
	public function register( $list ) {
		$list[ self::ID ] = (object) array(
			...
			'description' 	=> __( 'Adressiert EU-Mehrwertsteuerbestimmungen.', 'membership2' ),
			'icon' 			=> 'wpmui-fa wpmui-fa-euro',
			'details' 		=> array(
				array(
					'type' 	=> MS_Helper_Html::TYPE_HTML_TEXT,
					'title' => __( 'Einstellungen', 'membership2' ),
					'value' => __( 'Wenn dieses Add-On aktiviert ist, wird auf der Seite "Einstellungen" ein neuer Abschnitt mit zusätzlichen Optionen angezeigt.', 'membership2' ),
				),
			),
		);
