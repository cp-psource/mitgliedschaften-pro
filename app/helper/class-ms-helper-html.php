...
class MS_Helper_Html extends MS_Helper {
	...
	public static function settings_footer( $fields = null, $submit_info = null ) {
		...
		$args = array(
			'saving_text'	=> __( 'Änderungen speichern...', 'membership2' ),
			'saved_text' 	=> __( 'Alle Änderungen gespeichert.', 'membership2' ),
			'error_text' 	=> __( 'Änderungen konnten nicht gespeichert werden.', 'membership2' ),
			'fields' 		=> $fields,
		);
