...
class MS_Helper_Period extends MS_Helper {
	...
	public static function get_period_types( $type = 'all' ) {
		$singular = array(
			'1' . self::PERIOD_TYPE_DAYS 	=> __( 'einen Tag', 'membership2' ),
			'1' . self::PERIOD_TYPE_WEEKS 	=> __( 'eine Woche', 'membership2' ),
			'1' . self::PERIOD_TYPE_MONTHS 	=> __( 'einen Monat', 'membership2' ),
			'1' . self::PERIOD_TYPE_YEARS 	=> __( 'ein Jahr', 'membership2' ),
			'1-' . self::PERIOD_TYPE_DAYS 	=> __( 'Tag', 'membership2' ),
			'1-' . self::PERIOD_TYPE_WEEKS 	=> __( 'Woche', 'membership2' ),
			'1-' . self::PERIOD_TYPE_MONTHS => __( 'Monat', 'membership2' ),
			'1-' . self::PERIOD_TYPE_YEARS 	=> __( 'Jahr', 'membership2' ),
		);
		$plural = array(
			self::PERIOD_TYPE_DAYS 			=> __( 'Tag', 'membership2' ),
			self::PERIOD_TYPE_WEEKS 		=> __( 'Woche', 'membership2' ),
			self::PERIOD_TYPE_MONTHS 		=> __( 'Monate', 'membership2' ),
			self::PERIOD_TYPE_YEARS 		=> __( 'Jahre', 'membership2' ),
		);
	...
	public static function get_period_desc( $period, $include_quanity_one = false ) {
		...
		$desc = str_replace(
			...
			array(
				__( 'Tage', 'membership2' ),
				__( 'Wochen', 'membership2' ),
				__( 'Monate', 'membership2' ),
				__( 'Jahre', 'membership2' ),
			),
			$desc
		);
