...
class MS_Gateway extends MS_Model_Option {
	...
	public function get_mode_types() {
		$mode_types = array(
			self::MODE_LIVE 	=> __( 'Live Webseite', 'membership2' ),
			self::MODE_SANDBOX 	=> __( 'Sandbox-Modus (Test)', 'membership2' ),
		);
	...
	public function is_configured() {
		MS_Helper_Debug::debug_log(
			sprintf(
				__( 'Überschreibe die Methode is_configured des %s-Gateways', 'membership2' ),
				$this->id
			)
		);
