...
class MS_Widget_Login extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'ms_widget_login',
			__( '[Mitgliedschaften] Einloggen', 'membership2' ),
			array(
				'description' => __( 'Zeige allen Gästen ein Anmeldeformular an. Angemeldete Benutzer sehen einen Link zum Abmelden.', 'membership2' ),
			)
		);
	}
	...
	public function form( $instance ) {
		$title 				= __( 'Einloggen', 'membership2' );
		$redirect_login 	= '';
		$redirect_logout 	= '';
		$shortcode_args 	= '';
		...
		$field_redirect_login = array(
			...
			'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
			'title'			=> __( 'Diese Seite nach dem Login anzeigen:', 'membership2' ),
		...
		$field_redirect_logout = array(
			...
			'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
			'title' 		=> __( 'Diese Seite nach dem Abmelden anzeigen:', 'membership2' ),
		...
		$field_shortcode_args = array(
			...
			'type' 			=> MS_Helper_Html::INPUT_TYPE_TEXT,
			'title' 		=> __( 'Shortcode Einstellungen:', 'membership2' ),
			'desc' 			=> sprintf(
				__( 'Argumente, die an den %sLogin-Shortcode%s übergeben werden sollen', 'membership2' ),
				sprintf(
