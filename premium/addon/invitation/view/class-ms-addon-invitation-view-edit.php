...
class MS_Addon_Invitation_View_Edit extends MS_View {
	...
	public function to_html() {
		...
		if ( $this->data['invitation']->is_valid() ) {
			$title = __( 'Einladungscode bearbeiten', 'membership2' );
		} else {
			$title = __( 'Einladungscode hinzufügen', 'membership2' );
		}
	...
	function prepare_fields() {
		...
		$fields = array(
			'code' => array(
				'id' => 'code',
				'title' => __( 'Einladungscode', 'membership2' ),
			...
			'start_date' => array(
				'id' => 'start_date',
				'title' => __( 'Startdatum', 'membership2' ),
			...
			'membership_id' => array(
				'id' => 'membership_id',
				'title' => __( 'Auf diese Mitgliedschaften kann eine Einladung angewendet werden', 'membership2' ),
			...
			'max_uses' => array(
				'id' => 'max_uses',
				'title' => __( 'Max. Anwendungen', 'membership2' ),
