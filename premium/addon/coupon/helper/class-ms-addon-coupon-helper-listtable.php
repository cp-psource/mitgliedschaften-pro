...
class MS_Addon_Coupon_Helper_Listtable extends MS_Helper_ListTable {
	...
	public function get_columns() {
		return apply_filters(
			...
			array(
				...
				'ccode' => __( 'Gutscheincode', 'membership2' ),
				'discount' => __( 'Rabatt', 'membership2' ),
				'start_date' => __( 'Startdatum', 'membership2' ),
				'expire_date' => __( 'Ablaufdatum', 'membership2' ),
				'membership' => __( 'Mitgliedschaft', 'membership2' ),
				'used' => __( 'Anwendungen', 'membership2' ),
				'remaining_uses' => __( 'Verbleibende Anwendungen', 'membership2' ),
			)
		);
	}
	...
	public function column_expire_date( $item ) {
		...
		if ( $item->expire_date ) {
			...
			$html = __( 'Kein Ablaufdatum', 'membership2' );
		}
