...
class MS_Addon_ExcludeFromSearch extends MS_Addon {
	...
	public function register( $list ) {
		$list[ self::ID ] = (object) array(
			'name' 			=> __( 'Systemseiten von der Suche ausschließen', 'membership2' ),
			'description' 	=> __( 'Schließt die Seiten des Mitgliedschaftssystems von den Suchergebnissen aus.', 'membership2' ),
