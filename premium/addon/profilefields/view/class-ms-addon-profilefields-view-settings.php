...
class MS_Addon_Profilefields_View_Settings extends MS_View {
	...
	public function render_tab() {
		...
		<div class="ms-addon-wrap">
			...
			MS_Helper_Html::settings_tab_header(
				array( 'title' => __( 'Einstellungen für Profilfelder', 'membership2' ) )
			);
	...
	public function prepare_fields() {
		...
		$registration_options = array(
			...
			'required' => __( 'Erforderlich', 'membership2' ),
		);

		$profile_options = array(
			'off' => '-',
			'readonly' => __( 'Schreibgeschützt', 'membership2' ),
			'optional' => __( 'Optional', 'membership2' ),
			'required' => __( 'Erforderlich', 'membership2' ),
		);
		...
		$rows = array();
		$rows[] = array(
			__( 'Feldname', 'membership2' ),
			__( 'Anmeldeformular', 'membership2' ),
			__( 'Profilformular', 'membership2' ),
		);
