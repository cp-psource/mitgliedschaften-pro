...
class MS_Addon_Profilefields extends MS_Addon {
	...
	public function settings_tabs( $tabs ) {
		$tabs[ self::ID  ] = array(
			'title' => __( 'Profilfelder', 'membership2' ),
	...
	public static function list_fields() {
		...
		if ( null === $Profile_Fields ) {
			...
			$Profile_Fields = array(
				'username' => array(
					'label' => __( 'Benutzername', 'membership2' ),
				...
				'first_name' => array(
					'label' => __( 'Vorname', 'membership2' ),
					'type' => MS_Helper_Html::INPUT_TYPE_TEXT,
					'default_reg' => 'optional',
					'default_edit' => 'optional',
				),
				'last_name' => array(
					'label' => __( 'Familienname', 'membership2' ),
					'type' => MS_Helper_Html::INPUT_TYPE_TEXT,
					'default_reg' => 'optional',
					'default_edit' => 'optional',
				),
				...
				'display_name' => array(
					'label' => __( 'Anzeigen als', 'membership2' ),
				...
				'website' => array(
					'label' => __( 'Webseite', 'membership2' ),
					'type' => MS_Helper_Html::INPUT_TYPE_TEXT,
				),
				'description' => array(
					'label' => __( 'Biografische Informationen', 'membership2' ),
					'type' => MS_Helper_Html::INPUT_TYPE_TEXT_AREA,
				),
				'password' => array(
					'label' => __( 'Passwort', 'membership2' ),
				...
				'password2' => array(
					'label' => __( 'Passwort Bestätigung', 'membership2' ),
					'type' => MS_Helper_Html::INPUT_TYPE_PASSWORD,
					'default_reg' => 'required',
					'default_edit' => 'optional',
					'allowed_reg' => array( 'off', 'required' ),
	...
	public function render_xprofile_field( $field_id, $setting, $field_value = null, $visibility = false ) {
		...
		<div class="ms-form-element ms-form-element-xprofile editfield field-<?php echo $field_id; ?>">
			...
			<?php if ( 'textarea' == bp_get_the_profile_field_type() ) { ?>
				...
				<label for="<?php bp_the_profile_field_input_name(); ?>"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(erforderlich)', 'membership2' ); ?><?php endif; ?></label>
			...
			<?php } elseif ( 'radio' == bp_get_the_profile_field_type() ) { ?>
				...
				<div class="radio">
					<span class="label"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(erforderlich)', 'membership2' ); ?><?php endif; ?></span>

					<?php do_action( bp_get_the_profile_field_errors_action() ); ?>
					<?php bp_the_profile_field_options( array( 'user_id' => get_current_user_id() ) ); ?>

					<?php if ( ! bp_get_the_profile_field_is_required() ) : ?>
						<a class="clear-value" href="javascript:clear( '<?php bp_the_profile_field_input_name(); ?>' );"><?php _e( 'Leeren', 'membership2' ); ?></a>
					<?php endif; ?>
				</div>
			...
			<?php } elseif ( 'datebox' == bp_get_the_profile_field_type() ) { ?>
				...
				<div class="datebox">
					<label for="<?php bp_the_profile_field_input_name(); ?>_day"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(erforderlich)', 'membership2' ); ?><?php endif; ?></label>
					<?php do_action( bp_get_the_profile_field_errors_action() ); ?>
			...
			<?php if ( $visibility ) : ?>
				...
				<?php if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
					<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
						<?php printf( __( 'Dieses Feld kann gesehen werden von: <span class="current-visibility-level">%s</span>', 'membership2' ), bp_get_the_profile_field_visibility_level_label() ) ?> <a href="#" class="visibility-toggle-link"><?php _ex( 'Ändern', 'Ändere die Sichtbarkeitsstufe des Profilfelds', 'membership2' ); ?></a>
					</p>

					<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
						<fieldset>
							<legend><?php _e( 'Wer kann dieses Feld sehen?', 'membership2' ) ?></legend>

							<?php bp_profile_visibility_radio_buttons() ?>

						</fieldset>
						<a class="field-visibility-settings-close" href="#"><?php _e( 'Schließen', 'membership2' ) ?></a>

					</div>
				<?php else : ?>
					<p class="field-visibility-settings-notoggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
						<?php printf( __( 'Dieses Feld kann gesehen werden von: <span class="current-visibility-level">%s</span>', 'membership2' ), bp_get_the_profile_field_visibility_level_label() ) ?>
					</p>
				<?php endif ?>
			<?php endif ?>
